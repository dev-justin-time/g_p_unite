...
const REGISTRY_ABI = [
    ...
    "function tasks(bytes32) view returns (bytes32 taskId, address requester, uint256 reward, uint256 deadline, bytes32 requirements, bytes32 inputCID, bytes32 outputCID, address assignedAgent, uint8 status, bytes32 proofHash, bool rewardWithdrawn, uint256 disputedAt, bytes32 assignedDid)",
