...
const RBAC_PERMISSIONS = {
  ...
  operator: { label: 'Operator', icon: '⚙', cssClass: 'operator', nav: ['onboarding', 'dashboard', 'agents', 'marketplace', 'staking', 'escrow', 'governance', 'reputation', 'chat', 'obscura', 'resources', 'settings'], actions: { stake: true, unstake: true, claim_task: true, create_proposal: true, vote: true, approve_milestone: true, send_chat: true, manage_roles: false, pause_contracts: false, emergency_actions: false, edit_settings: true, launch_node: true, configure_multi_sig: false } },
  viewer: { label: 'Viewer', icon: '👁', cssClass: 'viewer', nav: ['dashboard', 'agents', 'marketplace', 'governance', 'reputation', 'obscura', 'resources'], actions: { stake: false, unstake: false, claim_task: false, create_proposal: false, vote: false, approve_milestone: false, send_chat: false, manage_roles: false, pause_contracts: false, emergency_actions: false, edit_settings: false, launch_node: false, configure_multi_sig: false } }
};
